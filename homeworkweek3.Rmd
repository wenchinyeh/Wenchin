...
# summation
sum(seq(from=1,to=10))
# mean
mean(seq(from=1,to=10))
# standard deviation
sd(seq(from=1,to=10))
```
...
# Make a mistake here
install("You are not seeing what I am seeing")
```
...
y1<- abs(mean(rnorm(10,0,1) ))
y2<-abs(mean(rnorm(100,0,1) ))
y3<-abs(mean(rnorm(500,0,1) ))
y4<-abs(mean(rnorm(1000,0,1) ))
y5<-abs(mean(rnorm(5000,0,1) ))

x=c(10,100,500,1000,5000)
y=c(y1,y2,y3,y4,y5)
plot(x,y)
